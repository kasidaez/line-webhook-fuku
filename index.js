...
สอบถามหรือขอรับโปรได้ที่แอดมินเลยนะคะ 💬 👉 https://lin.ee/XvCd9w6`;
...
🔗 สมัครเองได้เลยที่: https://fuku888.imember.cc/customer/register/Fuku_TT
...
• เลขบัญชี / วอเล็ต`;
    ...
    reply = `🧨 เกมแตกง่ายช่วงนี้ (อัปเดตสด)
⚽ แทงบอล – โอกาสเข้าเต็มบิล ~🔹87%
🃏 บาคาร่า – อ่านเค้าไพ่ดี ๆ มีลุ้นสูง ~🔹73%
🎰 No Limit (สล็อต) – โบนัสเข้าไว ~🔹58%

📲 เข้าเล่นเลยตอนนี้ 👉 https://fuku888.imember.cc/login

สมัครฟรี ไม่มีขั้นต่ำ เล่นได้ทุกเกมในเว็บเดียว!
  } else if (
...
🔗 https://fuku888.imember.cc/customer/register/Fuku_TT`
